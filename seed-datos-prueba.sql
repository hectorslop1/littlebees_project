-- Script de datos de prueba para LittleBees
-- Este script crea datos básicos para probar la aplicación

-- Limpiar datos existentes (opcional, comentar si no quieres borrar)
-- DELETE FROM excuses;
-- DELETE FROM child_exercises;
-- DELETE FROM exercises;
-- DELETE FROM announcements;
-- DELETE FROM daily_log_entries;
-- DELETE FROM attendance_records;
-- DELETE FROM child_parents;
-- DELETE FROM emergency_contacts;
-- DELETE FROM child_medical_info;
...
-- 2. Crear Usuarios
INSERT INTO users (id, email, password_hash, first_name, last_name, phone, role, is_active, mfa_enabled, created_at, updated_at)
VALUES 
  -- Directora
  ('a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d', 'maria.garcia@petitsoleil.com', '$2b$10$abcdefghijklmnopqrstuvwxyz1234567890', 'María', 'García', '555-0101', 'director', true, false, NOW(), NOW()),
  -- Maestra Ana López
  ('b2c3d4e5-f6a7-4b5c-9d0e-1f2a3b4c5d6e', 'ana.lopez@petitsoleil.com', '$2b$10$abcdefghijklmnopqrstuvwxyz1234567890', 'Ana', 'López', '555-0102', 'teacher', true, false, NOW(), NOW()),
  -- Maestra Carmen Ruiz
  ('c3d4e5f6-a7b8-4c5d-0e1f-2a3b4c5d6e7f', 'carmen.ruiz@petitsoleil.com', '$2b$10$abcdefghijklmnopqrstuvwxyz1234567890', 'Carmen', 'Ruiz', '555-0103', 'teacher', true, false, NOW(), NOW()),
  -- Padre Juan Pérez
  ('d4e5f6a7-b8c9-4d5e-1f2a-3b4c5d6e7f8a', 'juan.perez@email.com', '$2b$10$abcdefghijklmnopqrstuvwxyz1234567890', 'Juan', 'Pérez', '555-0201', 'parent', true, false, NOW(), NOW()),
  -- Madre Laura Martínez
  ('e5f6a7b8-c9d0-4e5f-2a3b-4c5d6e7f8a9b', 'laura.martinez@email.com', '$2b$10$abcdefghijklmnopqrstuvwxyz1234567890', 'Laura', 'Martínez', '555-0202', 'parent', true, false, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET email = EXCLUDED.email;

-- 3. Relacionar usuarios con tenant
INSERT INTO user_tenants (user_id, tenant_id, created_at)
VALUES 
  ('a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d', 'd3bcd4e1-3ac0-40d7-b96a-f2b41449a92c', NOW()),
  ('b2c3d4e5-f6a7-4b5c-9d0e-1f2a3b4c5d6e', 'd3bcd4e1-3ac0-40d7-b96a-f2b41449a92c', NOW()),
  ('c3d4e5f6-a7b8-4c5d-0e1f-2a3b4c5d6e7f', 'd3bcd4e1-3ac0-40d7-b96a-f2b41449a92c', NOW()),
  ('d4e5f6a7-b8c9-4d5e-1f2a-3b4c5d6e7f8a', 'd3bcd4e1-3ac0-40d7-b96a-f2b41449a92c', NOW()),
  ('e5f6a7b8-c9d0-4e5f-2a3b-4c5d6e7f8a9b', 'd3bcd4e1-3ac0-40d7-b96a-f2b41449a92c', NOW())
